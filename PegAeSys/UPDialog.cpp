...
//			::SetWindowLong(GetDlgItem(hDlg,CUPDIALOG_PROGRESSBAR_ID), GWL_STYLE, PBS_MARQUEE);
//			SendMessage(GetDlgItem(hDlg,CUPDIALOG_PROGRESSBAR_ID),PBM_SETMARQUEE, true, 500);
			return TRUE;
		}
