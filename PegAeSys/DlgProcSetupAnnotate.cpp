...
BOOL CALLBACK DlgProcSetupTabAnnotate(HWND hDlg, UINT nMsg, WPARAM, LPARAM)
{
...
//	SPrefAnnotate prefAnnotate;
	...
	switch(nMsg)
	{
		...
		case WM_DIALOG_FOCUS:
		{
			...
			{
				case IDC_ANN_DEF_TXT:
					SetFocus(::GetDlgItem(hDlg, IDC_ANN_DEF_TXT));
					break;
				default:
